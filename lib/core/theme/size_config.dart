...
class IOSSizes {
  init(double? screenWidth, double? defaultSize, bool isTablet) {
    SizeConfig.fontSize1 =
        isTablet ? (defaultSize! * .2).sp : (screenWidth! * .02).sp;
    SizeConfig.fontSize2 =
        isTablet ? (defaultSize! * .25).sp : (screenWidth! * .055).sp;
    SizeConfig.fontSize3 =
        isTablet ? (defaultSize! * .3).sp : (screenWidth! * .06).sp;
    SizeConfig.fontSize4 =
        isTablet ? (defaultSize! * .4).sp : (screenWidth! * .07).sp;
    SizeConfig.fontSize5 =
        isTablet ? (defaultSize! * .7).sp : (screenWidth! * .08).sp;
...
class AndroidSizes {
  init(double? screenWidth, double? defaultSize, bool isTablet) {
    SizeConfig.fontSize1 =
        isTablet ? (defaultSize! * .2).sp : (screenWidth! * .02).sp;
    SizeConfig.fontSize2 =
        isTablet ? (defaultSize! * .25).sp : (screenWidth! * .045).sp;
    SizeConfig.fontSize3 =
        isTablet ? (defaultSize! * .3).sp : (screenWidth! * .05).sp;
    SizeConfig.fontSize4 =
        isTablet ? (defaultSize! * .4).sp : (screenWidth! * .055).sp;
    SizeConfig.fontSize5 =
        isTablet ? (defaultSize! * .7).sp : (screenWidth! * .07).sp;
