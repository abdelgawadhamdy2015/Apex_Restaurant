...
class ColorManger {
  static LinearGradient grayGrediant = LinearGradient(
    colors: [Color(0xFFB2B2B2), Color(0xFFB2B2B2).withAlpha(30)],
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
  );
  static LinearGradient mainBlueGrediant = LinearGradient(
  ...
  // static const Color backGroundGreen = Color.fromRGBO(235, 255, 238, 1);
